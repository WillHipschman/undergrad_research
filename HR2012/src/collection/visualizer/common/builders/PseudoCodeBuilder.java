package collection.visualizer.common.builders;
...
public class PseudoCodeBuilder {
	...
	public static void loadPseudocode() {
		...
		String vectorType = ListenableVector.class.getSimpleName();
		String vectorName = AListenableVector.class.getSimpleName();
		String vectorTypeImports = ListenableVector.class.getPackage()
				.getName();
